...
- [x] Этап 5: Frontend Auth — layout, формы, защита маршрутов
- [x] Этап 6: Frontend каталог — список, детали, фильтры, пагинация
- [x] Этап 7: Frontend CRUD + кабинет — формы ADMIN, дашборд пользователя
- [x] Этап 8: Полировка — адаптивность, toast, скелетоны, lint
